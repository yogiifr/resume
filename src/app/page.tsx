...
export default function Page() {
  return (
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
      <section className="mx-auto w-full max-w-[1440px] space-y-8 bg-white print:space-y-6">
        <div className="flex md:items-center justify-between flex-col-reverse gap-2 md:flex-row">
          ...
          <Avatar className="size-28">
            <AvatarImage
              ...
              className="border border-gray-300 rounded-xl bg-[#fefefe] shadow"
            />
        ...
        <div className="grid grid-cols-12 md:gap-12">
              ...
              {RESUME_DATA.work.map(work => {
                return (
                  <Card key={work.company}>
                    ...
                    <CardContent
                      className="mt-2 text-xs list-disc"
          ...
          <div className="col-span-12 md:col-span-5 flex flex-col gap-4 pt-4 md:pt-0">
            <Section>
            ...
            <Section className="print-force-new-page scroll-mb-16">
              ...
              <div className="-mx-3 -grid grid-cols-1 gap-3 print:grid-cols-2 print:gap-2 md:grid-cols-2 lg:grid-cols-2">
                {RESUME_DATA.sideProjects.map(project => {
                  return (
                    <ProjectCard
                      key={project.title}
                      title={project.title}
